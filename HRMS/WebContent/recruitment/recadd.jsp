...
$(document).ready(function(){
    ...
    $("#but1").click(function(){
      ...
      if(rgender=="" || $.trim(rgender).length==0){
          $("#label2").html("请填写性别！");
          return;
        }else{
      	  $("#label2").html("");
...
<div class="header">
 ...
 <%@ include file="../left.jsp" %>
    <div class="currmenu">
      <ul class="rig_nav">
        <li><a href="#" style="color:blue">添加招聘人信息</a></li>
        <li><a href="recquery.jsp">查询招聘人信息</a></li>
      </ul>
    </div>
      <h1  align="center"  id="a1">添加招聘人信息</h1>
 <br>
 <hr>
<br>
<form action="<c:url value='/RecServlet?method=recadd'/>" method="post">
<div  style="margin-left: 600px;"> 
 <div class="input-group">
  <span class="input-group-addon" id="basic-addon1">姓名</span>
  <input type="text"  id="rname" name="rname" style="width:300px;" 
  class="form-control" placeholder="员工的姓名（必填）">
   <label id="label1" ></label>
</div>
<br>
 <div class="input-group">
  <span class="input-group-addon" id="basic-addon1">性别</span>
  <input type="text"  id="rgender" name="rgender" style="width:300px;"
  class="form-control" placeholder="员工的性别（必填）">
...
<br>
 <div class="input-group">
  ...
  <input type="text" id="rcellphone" name="rcellphone" style="width:300px;"
   class="form-control" placeholder="请填写电话（必填）" >
...
<br>
 <div class="input-group">
  ...
  <input type="text" id="diploma" name="diploma" style="width:300px;"
   class="form-control" placeholder="请填写文凭（可选）" >
</div>
<br>
 <div class="input-group">
  ...
  <input type="date"  name="age" style="width:270px;" class="form-control" >
   ...
   <br>
 <div class="input-group">
  <span class="input-group-addon" id="basic-addon1">具体描述</span>
...
<br>
    ...
    <div >
    <button type="button"  class="btn btn-success" id="but1">添加招聘人信息</button>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;
		<button type="reset" class="btn btn-danger"> 重置招聘人信息</button>
    </div>
    </div>
 </form>
