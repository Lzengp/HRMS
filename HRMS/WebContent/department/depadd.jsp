   ...
   <%@include file="../left.jsp" %>
    ...
    <div class="currmenu">
      <ul class="rig_nav">
        ...
        <hr>
 <h1  align="center"  id="a1">添加部门信息</h1>
 <br>
 <hr>
<br>
...
<input type="hidden" name="method" value="depadd"/>

<div  style="margin-left: 600px;"> 

 <div class="input-group">
  <span class="input-group-addon" id="basic-addon1">部门编号</span>
  <input type="text"  id="did"  name="did" style="width:300px;" class="form-control" placeholder="部门编号" aria-describedby="basic-addon1">
  <label id="label1" ></label>
</div>
<br>
 <div class="input-group">
  <span class="input-group-addon" id="basic-addon1">部门名称</span>
  <input type="text"  id="dname" name="dname" style="width:300px;" class="form-control" placeholder="部门名称" aria-describedby="basic-addon1">
   <label id="label2" ></label>
</div>
<br>
 <div class="input-group">
  <span class="input-group-addon" id="basic-addon1">部门经理</span>
  <input type="text"  id="dmanager" name="dmanager" style="width:300px;" class="form-control" placeholder="部门经理" aria-describedby="basic-addon1">
  <label id="label3" ></label>
</div>
<br>
 <div class="input-group">
  <span class="input-group-addon" id="basic-addon1">部门人数</span>
  <input type="text"  name="dnumber" style="width:300px;" class="form-control" placeholder="部门人数" aria-describedby="basic-addon1">
</div>
<br>
 <div class="input-group">
  <span class="input-group-addon" id="basic-addon1">部门描述</span>
  <input type="text" name="ddescription" style="width:300px;" class="form-control" placeholder="部门描述" aria-describedby="basic-addon1">
</div>
</div>
   ...
   <br>
    <div align="center">
    <button type="button"  class="btn btn-success" id="but1">添加部门信息</button>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;
		<button type="reset" class="btn btn-danger"> 重置部门信息</button>
    </div>
 </form>
 </div>
